    ...
    private static final Map<Integer, Integer> EXP_TABLE = new LinkedHashMap<Integer, Integer>() {
        {
            ...
            this.put(166, 7920000);
            this.put(167, 8033000);
            this.put(168, 8172000);
            this.put(169, 8350000);
            this.put(170, 8580000);
            this.put(171, 8875000);
            this.put(172, 9248000);
            this.put(173, 9705000);
            this.put(174, 10266000);
            this.put(175, 10950000);
            this.put(176, 11100000);
            this.put(177, 11300000);
            this.put(178, 11600000);
            this.put(179, 12100000);
            this.put(180, 13000000);
            this.put(181, 13200000);
            this.put(182, 13600000);
            this.put(183, 14200000);
            this.put(184, 15000000);
            this.put(185, 16000000);
            this.put(186, 17200000);
            this.put(187, 18600000);
            this.put(188, 20200000);
        }
    };
